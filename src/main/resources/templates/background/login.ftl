...
<div class="login">
	<h1>Login</h1>
	<form method="post">
		<input type="text" name="u" 	id="adminName" placeholder="用户名" required="required" />
		<input type="password" name="p" id="adminPasswd" placeholder="密码" required="required" />
		<button type="button" class="btn btn-primary btn-block btn-large" onclick="adminLogin()">登录</button>
	</form>
</div>
