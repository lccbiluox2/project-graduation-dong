...
CREATE TABLE `group` (
  ...
  `user_code` int(5) DEFAULT NULL COMMENT '用户的id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

/*Data for the table `group` */

insert  into `group`(`id`,`g_name`,`g_desc`,`user_code`) values (1,'管理员','管理所有',0),(2,'普通用户','操作自己的发布信息',4),(3,'新闻管理员','操作新闻',NULL);
...
CREATE TABLE `house` (
  ...
  `h_home_count` int(10) DEFAULT NULL COMMENT '房屋室内个数',
  ...
  `h_hignt` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '房屋在地下室  一楼  高处 高度等',
...
CREATE TABLE `user` (
  ...
  `user_code` varchar(4) COLLATE utf8_bin DEFAULT NULL COMMENT '用户代码（当时插入用户时候的id）',
...
insert  into `user`(`id`,`user_code`,`user_name`,`user_passwd`,`user_email`,`user_phone`) values (4,'4','aa','bb','bb','gg');
